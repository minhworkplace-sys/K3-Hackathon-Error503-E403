...
def get_collection():
    # M3: embedding function chọn theo LLM_MODE (mock|gemini) — lazy mỗi lần
    # gọi thay vì cache 1 lần ở module-load, để đổi LLM_MODE giữa các lần
    # test (VD reindex script) không cần restart process.
